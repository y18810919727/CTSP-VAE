...
from lib.ode_func import ODEFunc_w_Poisson, ODEFunc, CDEFunc, CDEFunc_w_Poisson
...
def create_spvae_model(args, input_dim, z0_prior, obsrv_std, device,
    ...
    diffeq_solver = DiffeqSolver(gen_data_dim, gen_de_func, 'dopri5', args.latents,
                                 odeint_rtol = 1e-3, odeint_atol = 1e-4, device = device)

    ct_sp_latent_prior = GaussPrior(latent_dim=args.z0_dim, type=args.prior)
    SPVAE(
