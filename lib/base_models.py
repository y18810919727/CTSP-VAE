...
from lib.likelihood_eval import masked_gaussian_log_density, compute_mse, compute_poisson_proc_likelihood, \
    compute_binary_CE_loss, compute_multiclass_CE_loss
...
class VAE_Baseline(nn.Module):
    def __init__(self, input_dim, latent_dim,
                 z0_prior, device,
                 obsrv_std = 0.01,  # constant std for observation
